...
def plot_progess_images(gen,e,GMIGAN=True):
  ...
  ax = axes[2,1]
  ax.imshow(fake_cs[23,:,:,0],vmin=-1,vmax=1,cmap='Spectral_r')
  ax.set_xticks([])
  ax.set_yticks([])
  ax = axes[3,1]
  ax.imshow(cs_scenes_b[23,:,:,0],vmin=-1,vmax=1,cmap='Spectral_r')
  ax.set_xticks([])
  ax.set_yticks([])
  ...
  ax = axes[2,3]
  ax.imshow(fake_cs[28,:,:,0],vmin=-1,vmax=1,cmap='Spectral_r')
  ax.set_xticks([])
  ax.set_yticks([])
  ax = axes[3,3]
  ax.imshow(cs_scenes_b[28,:,:,0],vmin=-1,vmax=1,cmap='Spectral_r')
  ax.set_xticks([])
  ax.set_yticks([])
...
#         **train_kwargs)
#     train_cs_modis_cgan(num_epochs=9, epoch=37, batch_size=256,
#         **train_kwargs)
#     train_cs_modis_cgan(num_epochs=20, epoch=46, batch_size=512,
#         **train_kwargs)
    train_cs_modis_cgan(num_epochs=48, epoch=102, batch_size=512,
        **train_kwargs)
